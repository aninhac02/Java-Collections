...
public class TesteEmptySet {
    ...
    public static void main(String[] args) {
        ...
        * Também não podemos! Recebemos a mesma exceção: UnsupportedOperationException
         ...
         Por exemplo, imagina que você precisa representar um curso que foi cancelado pois não teve matriculas. Nesse caso faria to-do sentido devolver um Collections.emptySet()
*     */
    }
}
